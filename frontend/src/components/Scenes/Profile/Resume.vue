        ...
        <div>
            <div class="">
                <label for="resume-upload-input" class="cursor-pointer inline-block">
                    <div
                        class="mw-[186px] inline-block h-[44px] border-neutral-100 border-[2px] rounded-md flex justify-center items-center">
                        ...
                        <div class="bg-primary-100 w-[20px] h-[20px] rounded-lg ml-[10px] relative mt-[2px] mr-[15px]">
                            <font-awesome-icon icon="fa-arrow-down"
                                class="text-primary-500 text-[14px] absolute top-[3px] left-[4px]" />
                ...
                <div class="flex">
                    <div class="bg-primary-500 text-neutral-0 active:bg-white:text-primary-500 flex justify-center items-center rounded-md w-[120px] h-[38px] mb-[10px] hover:bg-primary-600 capitalize font-bold text-[14px] text-center"
                ...
                <div v-if="modalActive" class="bg-white absolute top-0 bottom-0 left-0 right-0 z-10 ">
                    ...
                    <div v-if="this.user.resumeURL"> -->
                        <object :data="pdfSrc" class="w-full h-full pt-[60px]" type="application/pdf">
                            <div>No online PDF viewer installed</div>
                        </object>
                    
                        <!-- <vue-pdf-embed :source="pdfSrc" /> -->
                    <!-- </div> -->
                    <!-- <div v-else="this.resumeFile">
                        <vue-pdf-embed :source="this.resumeFile" />
                    </div>
                </div> -->
