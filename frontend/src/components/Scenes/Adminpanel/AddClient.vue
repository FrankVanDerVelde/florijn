    ...
    <div class="profile-container flex self-center w-4/5">
      <div class="grid grid-cols-3 gap-4">
        <form @submit.prevent="addClient()">
          ...
          <input class="rounded border-[1px] border-neutral-200" v-model="name" type="text" placeholder="naam bedrijf" id="bedrijfsnaam" name="name"><br><br><br>
          ...
          <input class="rounded border-[1px] border-neutral-200" type="password" v-model="password" placeholder="wachtwoord" name="password"><br><br><br>
